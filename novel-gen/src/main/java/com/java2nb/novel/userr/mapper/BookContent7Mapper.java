...
import static com.java2nb.novel.userr.mapper.BookContent7DynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.java2nb.novel.userr.entity.BookContent7;
...
public interface BookContent7Mapper {
    ...
    BookContent7 selectOne(SelectStatementProvider selectStatement);
    ...
    default DeleteDSL<MyBatis3DeleteModelAdapter<Integer>> deleteByExample() {
        return DeleteDSL.deleteFromWithMapper(this::delete, bookContent7);
    }
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<BookContent7>>> selectByExample() {
        return SelectDSL.selectWithMapper(this::selectMany, id, indexId, content)
                .from(bookContent7);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default QueryExpressionDSL<MyBatis3SelectModelAdapter<List<BookContent7>>> selectDistinctByExample() {
        return SelectDSL.selectDistinctWithMapper(this::selectMany, id, indexId, content)
                .from(bookContent7);
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default BookContent7 selectByPrimaryKey(Long id_) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(BookContent7 record) {
        return UpdateDSL.updateWithMapper(this::update, bookContent7)
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(BookContent7 record) {
        return UpdateDSL.updateWithMapper(this::update, bookContent7)
