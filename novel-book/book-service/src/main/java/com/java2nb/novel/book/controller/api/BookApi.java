...
public class BookApi {
    ...
    boolean addBookCommentReply(@RequestParam("userId") Long userId, @RequestParam("CommentId") Long CommentId, @RequestBody BookCommentReply comment){
        bookService.addBookCommentReply(userId, CommentId, comment);
        return true;
    }
