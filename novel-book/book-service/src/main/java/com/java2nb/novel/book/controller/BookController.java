...
public class BookController {
    ...
    public ResultBean<BookIndex> queryBookIndex(@ApiParam("小说ID") @RequestParam("bookIndexId") Long bookIndexId){
     ...
     * 章节内容更新
     */
    @ApiOperation("章节内容新增接口")
    @GetMapping("addBookChatperContent")
    public ResultBean addBookChatperContent(@ApiParam("书籍id") @PathVariable("id") Long bookId,
                                            @ApiParam("章节号") @PathVariable("index_num") Integer indexNum,
                                            @ApiParam("章节名称") @PathVariable("index_name") Integer indexName,
                                            @ApiParam("字数") @PathVariable("wordCount") Integer wordCount,
                                            @ApiParam("内容") @PathVariable("content") String Content){
        bookService.addBookChatperContent(bookId, indexNum, indexName, wordCount, Content);
        return ResultBean.ok();
    }
