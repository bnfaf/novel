...
public interface BookService {
    ...
    void addBookCommentReply(Long userId, Long commentId, BookCommentReply comment);

    void addBookChatperContent(Long bookId, Integer indexNum, Integer indexName, Integer wordCount, String content);
}
